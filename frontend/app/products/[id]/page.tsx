                            ...
                            <div className="grid grid-cols-4 gap-2">
                                {product.images.slice(1, 5).map((img: string, idx: number) => (
                                    <div key={idx} className="relative aspect-square">
                                        <Image src={img} alt={`${product.name} ${idx + 2}`} fill className="object-cover rounded" />
                                    </div>
                                ))}
                            </div>
                        )}
                            ...
                            <table className="w-full">
                                <tbody>
                                    ...
                                    {product.type === 'battery' && (
                                        <>
                                            <tr className="border-b">
                                                <td className="py-2 font-medium">Voltage</td>
                                                <td className="py-2 text-gray-600">{product.specs.voltage}V</td>
                                            </tr>
                                            <tr className="border-b">
                                                <td className="py-2 font-medium">Capacity</td>
                                                <td className="py-2 text-gray-600">{product.specs.ampereHours}Ah</td>
                                            </tr>
                                        </>
                                    )}
                                </tbody>
