...
export default function AccessoriesPage() {
    const [filters, setFilters] = useState<any>({ type: 'accessory', inStock: false });
    ...
    const { data: productsData, isLoading } = useQuery({
        queryKey: ['accessories', filters, sort, page],
    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            <div className="text-center mb-12">
                <h1 className="text-5xl md:text-6xl font-semibold text-[var(--text-main)] mb-4">Auto Accessories</h1>
                <p className="text-xl text-[var(--text-muted)] font-light max-w-2xl mx-auto">
                    Complete your vehicle with premium accessories.
                </p>
            </div>
