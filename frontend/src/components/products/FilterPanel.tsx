...
export function FilterPanel({
    ...
    return (
        <div
            className={cn(
                'rounded-lg border border-[var(--border-color)] bg-[var(--card-bg)] p-6 text-[var(--text-main)]',
                isMobile && 'max-h-screen overflow-y-auto'
            )}
        >
            {isMobile && (
            ...
            <div className="mb-6">
                <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                        ...
                        className="h-4 w-4 rounded border-[var(--border-color)] text-primary-900 focus:ring-primary-500"
                    />
            ...
            <div className="mb-6">
                ...
                <div className="space-y-2">
                    <input
                        ...
                        className="w-full rounded-lg border border-[var(--border-color)] bg-[var(--card-soft-bg)] px-3 py-2 text-[var(--text-main)]"
                    />
                    <input
                        type="number"
                        placeholder="Max"
                    ...
                    <div className="mb-6">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            <input
                                ...
                                className="rounded-lg border border-[var(--border-color)] bg-[var(--card-soft-bg)] px-3 py-2 text-[var(--text-main)]"
                            />
                            <input
                                type="text"
                                placeholder="Profile"
